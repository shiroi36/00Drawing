;;---------------------------=={  Script Writer  }==-----------------------------;;
;;         使用方法は：https://www.noboyu.com/script-writer-autocad/             ;;
;;                                                                               ;;
...
;;-------------------------------------------------------------------------------;;
;;                                                                               ;;
;;  Author: Lee Mac, Copyright ｩ May 2010 - www.lee-mac.com                      ;;
;;                                                                               ;;
;;-------------------------------------------------------------------------------;;
;;                                                                               ;;
;;  Version:                                                                     ;;
...
(vl-load-com)
(princ "\n:: Script Writer | Version 1.2 | ｩ Lee Mac 2010 www.lee-mac.com ::")
