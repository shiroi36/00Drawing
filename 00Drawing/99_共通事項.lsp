...
(setq 0mybldg_更新日 "2023年1月24日")
:%<\AcVar.17.0 Lisp.0mybldg_物件名>%
(setq 0mybldg_物件名 "(仮称)市川市柏井町1丁目計画")
...
(setq 0mybldg_1FLto設計GL "設計GL+1100")
...
(setq 0mybldg_基礎梁下端 "1FL-1200")
:%<\AcVar.17.0 Lisp.0mybldg_基礎下端>%
(setq 0mybldg_基礎下端 "1FL-1400")
:%<\AcVar.17.0 Lisp.0mybldg_カスタム上端1>%
(setq 0mybldg_カスタム上端1 "1FL-1000")
:%<\AcVar.17.0 Lisp.0mybldg_カスタム上端2>%
(setq 0mybldg_カスタム上端2 "1FL-1300")
